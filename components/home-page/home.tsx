    ...
    <Flex direction="column" align="center">
      <Flex direction={['column', 'column', 'row']}>
        ...
        >
          ...
          <Box as="h2" fontSize="lg" fontWeight="400" textAlign="left">
            My name is{' '}
            <Box as="strong" fontWeight="600">
              DEE
            </Box>{' '}
            and I&apos;m a{' '}
            <Box as="i" whiteSpace="nowrap">
             SE {' '}
             </Box>
          ...
          <Box as="h2" fontSize="lg" fontWeight="400" mt={1} textAlign="left">
            Wellcome to my digital garden, where I write about the things I&apos;m working on and share
            what I&apos;ve learned.
          </Box>
        </MotionFlex>
      </Flex>
